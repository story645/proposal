...
This work is motivated by a rearchitecture of the Matplotlib visualization library that aims to disentangle the transformation from data to visualization. 
...
\subsection{contribution of this work is}
