...
I like your framing
and "we validate the framework by using it to re-design artist and data access layer of Maptlotlib, a general purpose visualization tool"
...
\end{figure}
%% find a way to work friendly in
