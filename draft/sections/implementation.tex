...
\begin{description}
    \item[\textbf{\vchannel}] encoder functions, can be \mintinline{python}{Encoder.__call__} method
    \item[\textbf{\vtotal}]  \mintinline{python}|{parameter:(variable, encoder)}| curried until {Artist.draw}
    ...
    \item[\textbf{\vartist}] \mintinline{python}{Artist.draw}, which is \vartisteq\ parameterized by \vtotal
   
    \item[\textbf{\vmarkd}] \mintinline{python}{Artist.assemble(visual)}  
\end{description}
