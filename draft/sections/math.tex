...
%%find word to put here topological total space that encodes points and a topological base space that can encode the connectivity of those points:
\begin{itemize}
...
%%insert little thickness sketch maybe?O->(O)
