...
As illustrated in figure~\ref{fig:math:data:fiber}, Spivak's framework provides a consistent way to describe potentially complex components of the input data. 
