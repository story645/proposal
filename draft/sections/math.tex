...
K is a triangulizable quotient topological space.
%%insert stuff about qotient spaces....
...
\end{equation}
where $C$ is a finite ordered set of columns in a database. We extend C to refer to the names of all distinct 
