...
\begin{itemize}
    ...
    \item monoid operations: $f: x\mapsto x + \delta_1 $, $g: x\mapsto x + \delta_2  $
...
\begin{equation}
    \begin{tikzcd}
        \reals \arrow[rd, "(x+\delta_1)\circ(x+\delta_2)"] \arrow[d, "x+\delta_2"'] &            \\
        \reals \arrow[r, "x+\delta_2"']                                   & \reals
    \end{tikzcd}
\end{equation}
where $\delta_1$ and $\delta_2$ are intervals between two temperatures $x$.  
