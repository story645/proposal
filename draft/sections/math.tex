...
\begin{table}[ht]
    ...
    \begin{tabulary}{\textwidth}{|l|C|L|}\hline
     $\nu_{i}$                      & $\mu_{i}$                                                            & $dom(\nu_{i})$  \\ \hline                                              
    position                    & x, y, z                                                          & $\mathbb{R}$   \\ \hline
    size                        & linewidth, markersize                                            & $\mathbb{R}$   \\ \hline
    shape                       & markerstyle                                                      & $((\mathbb{R}, \mathbb{R}), x \in \{0,1,2,3,4,79\})^{n}^{\dag}$ \\ \hline
    color                       & color, colors, linecolor, facecolor, markerfacecolor, edgecolor  & $\mathbb{R}^4$ \\ \hline
    \multirow{2}{*}{texture}    & hatch                                                            & $/^*\backslash^*-^*+^*x^*o^*O^*.^**^* \in \Sigma^{+}$ \newline $\Sigma=\{/, \backslash, |, -, +, x, o, O, ., *\}^{\ddag}$\\\cline{2-3}
                                & linestyle                                                        & $(\mathbb{Z}, (\mathbb{Z}^n))^{\dag}$ \\ \hline              
    \end{tabulary}
    \caption{\\
        \footnotesize{\dag $n>0$}\\
        \footnotesize{\ddag$\Sigma^+=\cup_{n\in\mathbb{Z}^+}\Sigma^n$}
