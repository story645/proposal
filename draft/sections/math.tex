...
\end{equation}
such that one record $r$ in the fiber would have the form $(tp, t, (la,ln))$. We also add the variable name and measurement scale $M$ monoid to the fiber $F_i$ such that 
\begin{align}
...
\subsubsection{Case Study: Temperature}
