...
%% whats the right model/abstraction for a visualization library? 
%% why? the role this math is serving - static type checking/ reflection
%% tracking/automatically inferring
%% bookend w/ how this math does the why 
%% if we deleted this, what would we lose? 
...
%%% \Gamma is total
%%% H is point wise -
%%% this map means we cna do this pointwise 
...
\subsubsection{+ union}
\begin{figure}
    \caption{components of axes + glyphs }
\end{figure}
...
%% but what if it;s supposed to be Bertin invariant? will do w/ inclusion of K
