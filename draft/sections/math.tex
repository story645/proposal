...
\label{sec:data}
%%% maybe change this to a generic representational data set
We build on Butler's fiber bundle driven abstraction of data formats\cite{butlerVectorBundleClassesForm1992,butlerVisualizationModelBased1989} because fiber bundles can express the properties of the variables(\ref{sec:data_fiber}), the continuity of the records (\ref{sec:data_base}), and distinct instances of records (\ref{sec:data_section}). The fiber bundles mentioned in this work are assumed to be locally trivial\cite{spanier1989algebraic,LocallyTrivialFibre} unless otherwise specified. 
