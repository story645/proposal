...
\begin{figure}[H]
    ...
    \caption{The artist $A$ converts an section of data $\tau$ into a section of visual equivalents $\mu$ that are then composed into a piece of a glyph defined by the graphic section $\rho$
    \note{might need to label this as E', V, H}}
