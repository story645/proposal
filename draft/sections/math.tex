...
\begin{threeparttable}
    ...
    \begin{tabulary}{\textwidth}{|l|L|L|}\hline
     $\bm{\nu_{i}}$                      & $\bm{\mu_{i}}$                                                            & $\bm{dom(\nu_{i})}$  \\ \hline                                              
    position                    & x, y, z                                                          & $\mathbb{R}$   \\ \hline
    size                        & linewidth, markersize                                            & $\mathbb{R}$   \\ \hline
    shape                       & markerstyle                                                      & $((\mathbb{R}, \mathbb{R}), x \in \{0,1,2,3,4,79\})^{n}$\tnote{\dag} \\ \hline
    color                       & color, colors, linecolor, facecolor, markerfacecolor, edgecolor  & $\mathbb{R}^4$ \\ \hline
    \multirow{2}{*}{texture}    & hatch                                                            & $/^*\backslash^*-^*+^*x^*o^*O^*.^**^* \in \Sigma^{+}$ \newline $\Sigma=\{/, \backslash, |, -, +, x, o, O, ., *\}$ \tnote{\ddag}\\\cline{2-3}
                                & linestyle                                                        & $(\mathbb{Z}, (\mathbb{Z}^n))$\tnote{\dag} \\ \hline              
    \end{tabulary}
    \begin{tablenotes}\footnotesize
        \item[\dag] $n>0$
        \item[\ddag]$\Sigma^+=\cup_{n\in\mathbb{Z}^+}\Sigma^n$
    \end{tablenotes}
