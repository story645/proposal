...
\begin{equation}
    \begin{tikzcd}
        \xi^*E \arrow[d, "\pi" description]              & E \arrow[d, "\pi" description] \arrow[l, "\xi^*" description]            \\
        U \arrow[u, "\xi^*\tau" description, bend right] & K \arrow[u, "\tau" description, bend right] \arrow[l, "\xi" description]
    \end{tikzcd}
\end{equation}
