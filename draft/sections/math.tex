...
\begin{tikzcd}
    \xi E \arrow[rr, "\Tau" description] \arrow[rd, "\xi \sigma" description, bend right] &     & H \arrow[ld] \\
    & S \arrow[lu, bend right] &             
    \end{tikzcd}


\subsubsection{Marks}
%% diagram of connected components/line thing
...
\begin{tikzcd}
    ...
    A_{\tau_1}: \arrow[u, shift right]   & \Gamma(E) \arrow[r] & \Gamma(H) & {} \arrow[loop, distance=2em, in=305, out=235]
\end{tikzcd}
