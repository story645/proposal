...
invariance: \mapto -> preserves operations/relations types
...
orbit- space of possible visualiztions by changing the constants of each aesthetic (or f_{red}->f_{green})  
...
\end{tabular}
\caption{Symmetries on variable columns C \caption{Symmetrys one the data preserved with each type of channel \cite{bertinIIPropertiesGraphic2011,munznerMarksChannels}}
\label{tab:symmetry_channel}
\end{table}
Combining 
\begin{equation}
    \label{eg:renderer}
