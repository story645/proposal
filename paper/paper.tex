...
\autoref{fig:math:artist:nu} illustrates a \vchannel\ that preserves partial order relations. 

Stevens scales\cite{stevensTheoryScalesMeasurement1946} are groups, which are monoids with invertible elements, 
...
\noindent where the group is a monoid with invertible elements. Therefore, a \vchannel\ is equivariant if it satisfies 
