...
to improve consistency, reusability, and discoverability, so that domain specific tool developers can build structure preserving visualization tools. To enable this rearchitecture, we first present a visualization model that formalizes the structure that a visualization preserves in terms of 
\begin{enumerate}
  \item equivaraiance of data and visual properties
  \item continuity of data and the graphic
  \item composibility of components developed in ths model
\end{enumerate}
